...
<body class="<?php echo $__env->yieldContent('classes_body'); ?>" <?php echo $__env->yieldContent('body_data'); ?>>
    ...
    <?php if(!config('adminlte.enabled_laravel_mix')): ?>
        ...
        <script src="<?php echo e(asset('vendor/demo.js')); ?>"></script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/alfaagenti/resources/views/vendor/adminlte/master.blade.php ENDPATH**/ ?>